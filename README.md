...
- `access.json`: guarda a configuração inicial do contador.
...
O contador usa `src/data/access.json` como configuração inicial e salva as visitas no `localStorage` do navegador em formato JSON.
